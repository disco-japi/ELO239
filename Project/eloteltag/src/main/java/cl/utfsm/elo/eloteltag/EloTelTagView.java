 ...
 *
 * <p>
 * Configura el círculo y la etiqueta del tag, bindeando sus posiciones
 * a las propiedades del modelo para que se muevan automáticamente.
 * También inicia un Timeline que cada 4 segundos:
 * </p>
 * <ol>
...
public class EloTelTagView extends Group {
     ...
     *
     * <p>
     * Genera un círculo rojo semitransparente que crece desde la posición
     ...
     *
     * <p>
     * Este efecto simula la "señal" que emite el tag para buscar
     * celulares cercanos.
     * </p>
     *
