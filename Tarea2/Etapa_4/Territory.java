 ...
 *
 * <p>Esta clase actúa como un contenedor que gestiona todos los dispositivos
 * en la simulación. Permite agregar equipos, moverlos todos simultáneamente
 * y buscar celulares cercanos a un tag o tablet.</p>
 *
...
public class Territory { // Piece of land where cellulars, tags, and tablets are located and moved.
     ...
     *
     * <p>Antes de mover cada celular, se reporta su posición actual a la ETNube.
     * Luego se actualiza la posición de cada equipo según su velocidad y ángulo.</p>
     *
     ...
     *
     * <p>Recorre todos los celulares y verifica si el tag está dentro del rango
     * de detección (definido por {@link EloTelTag#isWithinRange(Cellular)}).
     * Retorna el primer celular que encuentre dentro del rango.</p>
     *
     * @param tag Tag o tablet (hereda de EloTelTag) para el cual se busca un celular cercano
     * @return El primer celular dentro del rango de detección, o {@code null} si no hay ninguno
     */
