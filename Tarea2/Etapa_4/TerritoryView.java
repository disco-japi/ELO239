 ...
 *
 * <p>Esta clase maneja la representación visual del territorio, incluyendo:
 ...
 * los cálculos de rebote en los bordes.</p>
 *
 * <p>Las dimensiones del territorio ({@link #WIDTH} y {@link #HEIGHT}) se
 * obtienen automáticamente de la imagen de fondo y son utilizadas por la
 * clase {@link Equipo} para detectar y manejar los rebotes en los bordes.</p>
 *
...
public class TerritoryView extends ScrollPane {
   ...
   *
   * <p>Carga la imagen de fondo especificada en el archivo de configuración,
   ...
   * superpuesto donde se colocarán las vistas de los equipos.</p>
   *
   ...
   *
   * <p>Este método se utiliza para añadir las representaciones visuales
   ...
   * correspondientes según las coordenadas de cada equipo.</p>
   *
