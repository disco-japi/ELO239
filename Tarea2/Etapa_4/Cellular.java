 ...
 *
 * <p>Los celulares son los únicos dispositivos que conocen su propia posición
 * gracias al GPS. Pueden:</p>
 * <ul>
 *   <li>Reportar su propia posición a la ETNube cada vez que se mueven</li>
 *   <li>Reportar la posición de tags y tablets cercanos (dentro del rango de detección)</li>
 *   <li>Ejecutar FindMy para mostrar los equipos del dueño (implementado en la vista)</li>
 * </ul>
 *
 * <p>Los celulares se mueven autónomamente por el territorio siguiendo las
 * mismas reglas de movimiento que los demás equipos.</p>
 *
...
public class Cellular extends Equipo {
     ...
     *
     * <p>La posición reportada es la del celular (no la del tag), ya que
     * el tag no tiene GPS. Esto simula que el celular "detecta" al tag
     * dentro de su rango de alcance.</p>
     *
     ...
     *
     * <p>La posición reportada es la del celular (no la de la tablet), ya que
     ...
     *
     * <p>Se llama automáticamente cada vez que el celular se mueve
     * (dentro del método moveAll de Territory).</p>
     */
