 ...
 *
 * <p>La Tablet es similar a un {@link EloTelTag} pero con algunas diferencias:
 ...
 * la funcionalidad FindMy para mostrar los equipos de su dueño.</p>
 *
 * <p>El tiempo de búsqueda de celulares cercanos para las tablets es de
 * 5 segundos (mientras que para los tags es de 4 segundos).</p>
 *
...
public class Tablet extends EloTelTag {
     ...
     *
     * <p>El nombre del equipo se fija automáticamente como "Tablet".</p>
     *
