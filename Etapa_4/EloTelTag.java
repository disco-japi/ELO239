 ...
 *
 * <p>Similar a un AirTag, es un dispositivo que se puede adjuntar a objetos
 ...
 * están dentro del rango de detección.</p>
 *
 * <p>El rango de detección es de {@value #TRACKING_RANGE} píxeles
 * (10 metros en la simulación, asumiendo 1 píxel = 1 metro).</p>
 *
...
public class EloTelTag extends Equipo {
     ...
     *
     * <p>Calcula la distancia euclidiana entre el tag y el celular.
     * La distancia se redondea a 2 decimales.</p>
     *
