 ...
 *
 * <p>Esta clase maneja la representación visual de una tablet en la simulación.
 * Muestra un rectángulo verde para representar la tablet y una etiqueta con
 * el nombre de su dueño.</p>
 *
 * <p>Las tablets, al igual que los tags, no tienen GPS propio. Cada 5 segundos:</p>
 * <ul>
 ...
 * </ul>
 *
 * <p>La diferencia con los {@link EloTelTagView} es que las tablets
 * buscan celulares cada 5 segundos (los tags lo hacen cada 4 segundos).</p>
 *
...
public class TabletView extends Group {
     ...
     *
     * <p>Configura el rectángulo y la etiqueta de la tablet, bindeando sus
     * posiciones a las propiedades del modelo para que se muevan automáticamente.
     * También inicia un Timeline que cada 5 segundos:</p>
     * <ol>
     ...
     *
     * <p>Genera un círculo verde semitransparente que crece desde la posición
     ...
     *
     * <p>Este efecto simula la "señal" que emite la tablet para buscar
     * celulares cercanos. El color verde distingue la señal de una tablet
     * de la señal roja de un tag.</p>
     *
